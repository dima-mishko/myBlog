...
// запрос к бд
$sql = mysqli_query($db, "select u.login, p.title,p.id,p.text,p.image from users u inner join posts p on p.id_user=u.id where u.login = '{$_POST['bloger']}' LIMIT $startIndex, $countView") or die(mysqli_error());
$newsData = array();
